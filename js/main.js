  ...
  `).join('');
    ...
    const CITY_FA = {
      rajahmundry: { fa: 'fa-water', color: '#2980b9', photo: 'https://images.unsplash.com/photo-1625732753949-d33dce4e61c2?w=400&q=80&auto=format&fit=crop' },
      kakinada: { fa: 'fa-anchor', color: '#1a3568', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80&auto=format&fit=crop' },
